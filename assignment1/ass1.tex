...
then ,we can get \\
$$\frac{P(y=1|x)}{P(y=0|x)} = \frac{P(x|y=1)P(y=1)}{P(x|y=0)P(y=1)}$$
...
$$=log\frac{p}{1-p}+\sum\limits_{i=1}^nx_ilog\frac{a_i(1-a_i)(1-a_i)^{-1}}{b_i(1-b_i)(1-b_i)^{-1}}$$
...
So , we can get 
$$m = log\frac{p}{1-p} + \sum\limits_{i=1}^nlog\frac{1-a_i}{1-b_i} $$
