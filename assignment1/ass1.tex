...
\section*{question 3}
\subsection*{3.1}
For given $u_j$,we can write the log likelihood function

$$\ell(u|q)=\sum\limits_{j=1}^nlogP(u_j|q)$$
$$\Longrightarrow \sum\limits_{j=1}^nlog(\left( \begin{array}{c} 1 \\ u_j \end{array} \right)q^{\frac{u_jp_{1j}}{p_{1j}+p_{2j}}}(1-q){^{\frac{u_jp_{2j}}{p_{1j}+p_{2j}}}})$$

$$\Longrightarrow \sum\limits_{j=1}^n(log\left( \begin{array}{c} 1 \\ u_j \end{array} \right)+{{\frac{u_jp_{1j}}{p_{1j}+p_{2j}}}log (q)}+ {{\frac{u_jp_{2j}}{p_{1j}+p_{2j}}}log(1-q)})$$

\subsection*{3.2}
Let's find the partial derivative of $q$ for the likelihood log:
$$\frac{\partial logP}{\partial q} = \sum\limits_{j=1}^n(\frac{u_j \cdot p_{2j}}{p_{1j}+p_{2j}} \cdot q + \frac{u_j \cdot p_{2j}}{p_{1j}+p_{2j}} \cdot (1-q))$$
\newpage
...
$\Longrightarrow q = 0.5546428571428571$

So,the MLE of $q1 =  0.5546428571428571$ and $q2 = 0.4453571428571429 $
